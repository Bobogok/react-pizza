          ...
          <div className="cart">
            <div className="cart__top">
              ...
              <div className="cart__clear">
                ...
                <span onClick={onClearCart} className="cart__clear-description">
                  Очистить корзину
                </span>
              </div>
            </div>
            ...
            <div className="cart__bottom">
              ...
              <div className="cart__bottom-buttons">
                <Link to="/" className="cart__bottom-back-btn button button--outline button--add">
                ...
                <Button className="cart__bottom-pay-btn" onClick={onClickOrder}>
              ...
              isOrderCompleted ? (
                <>
                  <img
                    ...
                    width="auto"
                    height="100%"
                    src={`data:image/png;base64, ${completeCart}`}
                    alt="Complete order"
                  />
                </>
              ) : (
